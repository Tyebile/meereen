...
public interface UserTokenManager {
     ...
     *
     * @param token 令牌
     * @see com.tyebile.meereen.authorization.api.token.event.UserTokenRemovedEvent
     */
     ...
     * @param userId userId
     * @param state  状态
     * @see com.tyebile.meereen.authorization.api.token.event.UserTokenChangedEvent
     ...
     * @see com.tyebile.meereen.authorization.api.token.event.UserTokenCreatedEvent
     */
